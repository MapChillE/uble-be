...
public class CreatePinRes {
    ...
    public static CreatePinRes of(Long pinId, String name, double longitude, double latitude, String address) {
        return CreatePinRes.builder()
                .pinId(pinId)
                .name(name)
                .longitude(longitude)
                .latitude(latitude)
